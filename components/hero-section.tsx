...
export function HeroSection() {
  ...
  useEffect(() => {
    // Use rAF so paint isn't blocked by state flush
  ...
  const handleExploreEnter = useCallback((e: React.MouseEvent<HTMLButtonElement>) => {
    e.currentTarget.style.borderColor = "#C9862b"
    e.currentTarget.style.color = "#C9862b"
  }, [])
  const handleExploreLeave = useCallback((e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    <section className="relative min-h-screen flex items-stretch overflow-hidden bg-[#f7f4ef]">
      ...
      <div
        ...
        style={{
          left: "50%",
          width: "1px",
          background: "linear-gradient(to bottom, transparent 0%, #C9862b 30%, #C9862b 70%, transparent 100%)",
          opacity: 0.35,
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto grid lg:grid-cols-2 items-center px-6 sm:px-10 lg:px-16 py-28 sm:py-32 gap-10 lg:gap-0">
        ...
        <div className="flex flex-col justify-center">
          ...
          >
            <div
              ...
              style={{ background: "rgba(201,134,43,0.1)", border: "1px solid rgba(201,134,43,0.3)" }}
            >
        ...
        <div className="hidden lg:flex flex-col items-end justify-end pb-10 pr-4">
          <div
            ...
            style={{ transitionDelay: "500ms", willChange: "transform, opacity" }}
          >
            <div
            ...
            >
              ...
              {DESKTOP_STATS.map((stat, i) => (
                ...
                >
                  ...
                  <span className="text-sm leading-snug" style={{ color: "#444", fontFamily: "'Inter', sans-serif" }}>
                    {stat.label}
                  </span>
                </div>
              ))}
        ...
        >
          {MOBILE_STATS.map((stat) => (
            ...
            >
              <div className="font-bold text-xl sm:text-2xl mb-0.5" style={{ color: "#C9862b", fontFamily: "'Poppins', sans-serif" }}>
                {stat.value}
              </div>
              <div className="text-[10px] sm:text-xs" style={{ color: "#555", fontFamily: "'Inter', sans-serif" }}>
                {stat.label}
              </div>
            </div>
          ))}
      ...
      >
        <div className="w-px h-12" style={{ background: "linear-gradient(to bottom, rgba(201,134,43,0.6), transparent)" }} />
      </div>
    </section>
  )
}