...
export function AboutSection() {
  ...
  const trust = useMemo(() => [
    ...
    { icon: CheckCircle2, label: "RERA Approved — A50500044714" },
        ...
        <div className="grid lg:grid-cols-[1fr_1px_1fr] gap-0 items-start">
          ...
          >
            ...
            >
              ...
              {" "}(MAHA RERA No. A50500044714) and NMRDA sanctioned — with transparent pricing, clear titles, and no hidden charges.
            </p>
