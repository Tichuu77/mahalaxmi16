  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto pl-8 pr-8 sm:pl-16 sm:pr-12 lg:px-24 pt-12 pb-20 relative z-10">
        ...
        {/* ── Desktop: two-column timeline | Mobile: accordion ── */}
        <div className="grid lg:grid-cols-[1fr_1px_1fr] gap-0 items-start">
                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background: isOpen ? "#30534A" : "rgba(48,83,74,0.08)",
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p
                        ...
                        style={{ color: "#999", fontFamily: "'Inter', sans-serif", fontSize: "0.78rem" }}
                      >
                        {guide.description}
                      </p>
                    </div>
                  ...
                  >
                    <div
                      style={{
                        padding: "0 1.25rem 1.1rem 4.75rem",
                        borderTop: "1px solid rgba(48,83,74,0.08)",
                        paddingTop: "0.85rem",
                      }}
                    >
                      <ul className="space-y-2">
                        {guide.details.map((d, di) => (
          ...
          {/* ════ RIGHT — Visual step panel (desktop) ════ */}
          <div
          ...
          >
            ...
            {expandedIndex !== null && (() => {
              const active = guides[expandedIndex]
                  ...
                  <ul className="space-y-3">
                    {active.details.map((d, di) => (
                      <li key={di} className="flex items-start gap-3">
                        ...
                        <span className="text-sm leading-relaxed" style={{ color: "#555", fontFamily: "'Inter', sans-serif" }}>
                          {d}
                        </span>
                      </li>
                    ))}
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-[10px] tracking-[0.3em] uppercase font-bold" style={{ color: "#C9862b", fontFamily: "'Poppins', sans-serif" }}>
              Quick Tips
            </span>
          </div>
