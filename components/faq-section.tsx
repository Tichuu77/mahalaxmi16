    ...
    >
      ...
      >
        <span
          ...
          style={{ fontFamily: "'Poppins', sans-serif", fontSize: "0.95rem", color: isOpen ? "#C9862b" : "rgba(48,83,74,0.2)", minWidth: "28px" }}
        >
        ...
        <div className="flex-1 min-w-0">
          <p className="font-bold leading-snug transition-colors duration-200"
            style={{ fontFamily: "'Poppins', sans-serif", fontSize: "0.92rem", color: isOpen ? "#30534A" : "#0d0d0d" }}>
            {faq.question}
          </p>
          <span
      ...
      <div style={{ maxHeight: isOpen ? "300px" : "0px", overflow: "hidden", transition: "max-height 0.35s ease" }}>
        <div className="flex gap-3"
          style={{ padding: "0.9rem 1.25rem 1.1rem 3.5rem", borderTop: "1px solid rgba(48,83,74,0.08)" }}>
...
// Right panel — static structure, only stats change on mount
const SidePanel = memo(() => (
  <div className="hidden lg:flex lg:pl-14 flex-col gap-5">
    <div className="rounded-2xl p-7" style={{ background: "#30534A" }}>
      ...
      <h3 className="font-bold mb-2 text-white" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "1.2rem" }}>
      ...
      <div className="space-y-2.5">
        <button onClick={scrollToContact}
          ...
          style={{ background: "#C9862b", fontFamily: "'Poppins', sans-serif", letterSpacing: "0.04em" }}>
          Contact Us
        </button>
        <a href="tel:+918999537942"
          ...
          style={{ background: "rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.8)", border: "1px solid rgba(255,255,255,0.12)", fontFamily: "'Poppins', sans-serif", letterSpacing: "0.04em" }}>
          Call Now
        </a>
      </div>
    </div>

    <div className="rounded-2xl p-5" style={{ background: "#fff", border: "1px solid rgba(48,83,74,0.1)", boxShadow: "0 2px 10px rgba(48,83,74,0.05)" }}>
      <p className="text-[10px] uppercase tracking-wider font-bold mb-4" style={{ color: "#C9862b", fontFamily: "'Poppins', sans-serif" }}>
        Why trust us
      </p>
      {QUICK_STATS.map((s, i) => (
        <div key={s.stat} className="flex items-center gap-3 py-3"
          style={{ borderBottom: i < 2 ? "1px solid rgba(48,83,74,0.07)" : "none" }}>
          <span className="font-bold leading-none" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "1.3rem", color: "#C9862b", minWidth: "52px" }}>
            {s.stat}
          </span>
          <span className="text-xs" style={{ color: "#888", fontFamily: "'Inter', sans-serif" }}>{s.label}</span>
        </div>
      ))}
    </div>
  </div>
...
const MobileCTA = memo(() => (
  <div className="lg:hidden mt-8">
    <div className="rounded-2xl p-6 text-center" style={{ background: "#30534A" }}>
      <h3 className="font-bold mb-2 text-white" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "1.1rem" }}>
        Still have questions?
      </h3>
      ...
      <div className="flex gap-2">
        ...
        <a href="tel:+918999537942"
          ...
          style={{ background: "rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.8)", border: "1px solid rgba(255,255,255,0.12)", fontFamily: "'Poppins', sans-serif" }}>
          Call Now
        </a>
      </div>
    </div>
  ...
  return (
    <section ref={sectionRef} id="faq" className="relative overflow-hidden" style={{ background: "#f7f4ef" }}>
      ...
      <div className="flex items-center gap-4 pl-8 pr-8 sm:pl-16 sm:pr-12 lg:px-24 py-5 relative z-10"
        ...
        <span className="text-[10px] tracking-[0.35em] uppercase font-bold" style={{ color: "#C9862b", fontFamily: "'Poppins', sans-serif" }}>FAQ</span>
        <span className="flex-1 h-px" style={{ background: "rgba(48,83,74,0.1)" }} />
        <span className="text-[10px] tracking-[0.2em] uppercase font-medium" style={{ color: "rgba(48,83,74,0.35)", fontFamily: "'Inter', sans-serif" }}>{faqs.length} Questions</span>
      </div>

      <div className="max-w-[1400px] mx-auto pl-8 pr-8 sm:pl-16 sm:pr-12 lg:px-24 pt-12 pb-20 relative z-10">

        {/* Header */}
        <div className={`mb-10 sm:mb-12 transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
